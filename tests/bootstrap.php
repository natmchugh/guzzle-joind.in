...
spl_autoload_register(function($class) {
    if (0 === strpos($class, 'Guzzle\JoindIn')) {
        $class = str_replace('Guzzle\JoindIn', '', $class);
        if ('\\' != DIRECTORY_SEPARATOR) {
            $class = dirname(__DIR__) . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'Guzzle/JoindIn' . DIRECTORY_SEPARATOR . str_replace('\\', DIRECTORY_SEPARATOR, $class) . '.php';
        } else {
            $class = dirname(__DIR__) . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . 'Guzzle/JoindIn' . DIRECTORY_SEPARATOR . $class . '.php';
        }
